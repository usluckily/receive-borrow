  ...
  <transition name="page">
    <div class="all" style="z-index:1">
      ...
      <div class="con-box">
        ...
        <div class="item">
          <div v-if=" scenario != '003' ">
            {{ typeTxt }}: <input placeholder="请输入场地名称"
      ...
      <div class="con-box">
        ...
        <!--<div class="item">-->
          <!--<div>-->
            <!--物品种类 : <input placeholder="请输入物品种类" v-model="itemType.val" @input="search('itemType',$event)" @compositionstart="compositionstart" @compositionend="compositionend"/>-->
          <!--</div>-->
          <!--<div>-->
        ...
        <!--<div class="item">-->
          <!--<div>-->
            <!--物品名称 : <input placeholder="请输入物品名称（必填）" v-model="itemName.val" @input="search('itemName',$event)" @compositionstart="compositionstart" @compositionend="compositionend"/>-->
          <!--</div>-->
          <!--<div>-->
            <!--<img src="../../assets/img/icon/icon_audio@2x.png" class="icon"/>-->
          <!--</div>-->
      ...
      <div class="con-box">
        <div class="item">
          <div>
            发 &nbsp;放 &nbsp;人 :
            <!--<input placeholder="" v-model="itemman" readonly/>-->
            <span> {{ itemman }} </span>
          </div>
        </div>
      </div>
...
//  import mobiscroll from '@/assets/js/mobiscroll.custom.min'
//
